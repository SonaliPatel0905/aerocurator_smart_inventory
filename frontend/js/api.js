...
const Api = {
    ...
    resetPassword(token, password) { return this.post(`/reset-password/${token}`, { password }); },
    ...
    addUser(data)            { return this.post("/api/users/add", data); },
    ...
    updateRequestStatus(id, status)  { return this.patch(`/api/requests/${id}`, { status }); },
};
